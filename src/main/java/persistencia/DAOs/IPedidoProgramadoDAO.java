...
public interface IPedidoProgramadoDAO {
    ...
    List<PedidoProgramadoDTO> obtenerPorCliente(int idCliente) throws PersistenciaException;
    int contarPedidosPorCliente(int idCliente) throws PersistenciaException;
}
